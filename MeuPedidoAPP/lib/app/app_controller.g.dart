...
mixin _$AppController on _AppControllerBase, Store {
  ...
  ThemeData get getTheme =>
      (_$getThemeComputed ??= Computed<ThemeData>(() => super.getTheme,
              name: '_AppControllerBase.getTheme'))
          .value;

  final _$temaDarkAtom = Atom(name: '_AppControllerBase.temaDark');
  ...
  final _$codTemaAtualAtom = Atom(name: '_AppControllerBase.codTemaAtual');
  ...
  void setCodTemaAtual(String novo, {bool gravar = true}) {
    final _$actionInfo = _$_AppControllerBaseActionController.startAction(
        name: '_AppControllerBase.setCodTemaAtual');
    try {
  ...
  void setTemaDark(bool dark, {bool gravar = true}) {
    final _$actionInfo = _$_AppControllerBaseActionController.startAction(
        name: '_AppControllerBase.setTemaDark');
    try {
